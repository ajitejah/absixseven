...
urlpatterns = [ 
    ...
    path("<int:pretest_id>/student-list/", views.pretest_student_list,name="pretest_student_list" ),
    path("<int:pretest_id>/student-list/<int:attempt_id>/student-result/", views.pretest_student_result, name="pretest_student_result",),
