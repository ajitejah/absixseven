...
SECRET_KEY = 'django-insecure-f88vbp3tkeq@27aq4(l&_)p7s!e_sff-e0iun@2%vme*u--^&n'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                "app_guidance.context_processors.notification_context", 
            ],
        },
    },
]

WSGI_APPLICATION = 'absixseven.wsgi.application'
